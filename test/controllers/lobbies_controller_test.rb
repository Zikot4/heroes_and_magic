...
class LobbiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lobby" do
    assert_difference('Lobby.count') do
      post lobbies_url, params: { lobby: { count_of_users: @lobby.count_of_users, url: @lobby.url } }
    end
  ...
  test "should update lobby" do
    patch lobby_url(@lobby), params: { lobby: { count_of_users: @lobby.count_of_users, url: @lobby.url } }
